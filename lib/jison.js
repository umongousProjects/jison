...
_handle_error:
        ...
        switch (action[0]) {
            case 1: // shift
                ...
                if ( typeof sharedState.yy.lexDebugger !== 'undefined') {
                  sharedState.yy.lexDebugger[sharedState.yy.lexDebugger.length - 1].expected = getExpected(action[1]);
                }
                break;
            ...
            case 2:
                ...
                stack.push(newState);
                if ( typeof sharedState.yy.lexDebugger !== 'undefined' &&
                    !sharedState.yy.lexDebugger[sharedState.yy.lexDebugger.length - 1 - len].reduced
                  ) {
